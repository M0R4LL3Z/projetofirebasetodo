...
export default function Home() {
  ...
  useEffect(() => {
    const fetchData = () => {
      const unsubscribe = onValue(ref(db, `/Checkin/${id}`), (querySnapShot) => {
            ...
            <div className="max-w-md mx-auto">
              ...
              <div className="relative px-4 py-10 bg-white shadow-lg sm:rounded-3xl sm:p-20">
                ...
                <div className="my-4">
                  ...
                  <p className="text-gray-700">{`Local: ${place.id_local}`}</p>
                  <p className="text-gray-700">{`Observação: ${place.observacao}`}</p>
